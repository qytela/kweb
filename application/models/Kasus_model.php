...
class Kasus_model extends CI_Model {
  ...
  public function get_all() {
    ...
    $this->datatables->add_column('view', '<a href="javascript:void(0);" class="item-edit item-edit--margin" id="item-edit" data="$1"><i class="fas fa-pencil-alt"></i></a><a href="javascript:void(0);" class="item-delete" id="item-delete" data="$1"><i class="fas fa-trash"></i></a>',
                                          'id, no_telp');
  ...
  function get_recycle()
  {
    ...
    $this->datatables->add_column('view', '<a href="javascript:void(0);" class="item-edit item-edit--margin" id="item-recycle" data="$1"><i class="fas fa-redo"></i></a><a href="javascript:void(0);" class="item-delete" id="item-delete" data="$1"><i class="fas fa-trash"></i></a>',
                                          'id');
    return $this->datatables->generate();
  }
