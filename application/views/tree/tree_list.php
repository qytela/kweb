            ...
            <div class="row" id="cb_event_type">
              <div class="ml-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control--small date-label datepicker inputmask" name="date_awal" id="date_awal" data-mask="99-99-9999">
              ...
              <div class="ml-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control--small date-label datepicker inputmask" name="date_akhir" id="date_akhir" data-mask="99-99-9999">
                  <span class="date-label">DD-MM-YYYY</span>
                </div>
              </div>
            </div>
