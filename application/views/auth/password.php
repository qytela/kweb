        ...
        <form id="action-role">
          <div class="form-group" id="nama">
            ...
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Masukkan password lama" name="val-password_" id="val-password_">
            </div>
          </div>
          <div class="form-group" id="nama">
            <label>Password Baru <span class="text-danger">*</span></label>
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Masukkan password baru..." name="val-password_update" id="val-password_update">
            </div>
          </div>
          <div class="form-group" id="nama">
            <label>Konfimasi Password Baru <span class="text-danger">*</span></label>
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Konfirmasi password baru..." name="val-password_update_2" id="val-password_update_2">
            </div>
          </div>
        </form>
      </div>
